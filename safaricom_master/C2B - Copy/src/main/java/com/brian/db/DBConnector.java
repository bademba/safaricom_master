...
//    public static Connection newPostgresConnection() throws PSQLException, SQLException {
//
//        String driverurl = "jdbc:postgresql://localhost:5432/safaricomtest";
//        Properties props = new Properties();
//        props.setProperty("user", "postgres");
//        props.setProperty("password", "password123");
//        props.setProperty("ssl", "true");
//        Connection conn = DriverManager.getConnection(driverurl, props);
//        return conn;
//    }
